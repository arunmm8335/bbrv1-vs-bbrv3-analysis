...
eth1.set_attributes("100mbit", "1ms")         # h1 -> r1
etr1b.set_attributes("5mbit", "50ms", "pfifo")  # r1 -> r2 (bottleneck)
etr2b.set_attributes("100mbit", "1ms")        # r2 -> h2

eth2.set_attributes("100mbit", "1ms")         # h2 -> r2
etr2a.set_attributes("5mbit", "50ms")         # r2 -> r1
etr1a.set_attributes("100mbit", "1ms")        # r1 -> h1
...
exp = Experiment("tcp-bbr-point-to-point-3-laggy")
